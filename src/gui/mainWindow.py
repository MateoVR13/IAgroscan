...
class mainWindow(customtkinter.CTk):
    def __init__(self):
        ...
        self.sidebar_button_3 = customtkinter.CTkButton(self.sidebar_frame, command=self.sidebar_button_event, text="Informes")
        self.sidebar_button_3.grid(row=5, column=0, padx=20, pady=10, sticky="ew")
        
        self.sidebar_button_4 = customtkinter.CTkButton(self.sidebar_frame, command=self.sidebar_button_event, text="Estadísticas")
        ...
        # self.labelTextSugg.configure(state="disabled")
